...
///
/// Maps to the existing [`xai_grok_sampling_types::ApiBackend`] enum.
...
impl From<ApiBackend> for xai_grok_sampling_types::ApiBackend {
    fn from(val: ApiBackend) -> Self {
        match val {
            ApiBackend::ChatCompletions => xai_grok_sampling_types::ApiBackend::ChatCompletions,
            ApiBackend::Responses => xai_grok_sampling_types::ApiBackend::Responses,
            ApiBackend::Messages => xai_grok_sampling_types::ApiBackend::Messages,
        }
    }
}
